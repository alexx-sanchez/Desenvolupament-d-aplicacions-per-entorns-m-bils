<template>
  <q-page class="flex items-center justify-center q-pa-md">
    <q-card class="auth-card">
      <q-card-section>
        <h1 class="text-h5 text-white text-center q-mb-lg">Login</h1>
        ...
        <div class="q-mt-md q-gutter-sm column">
          ...
          <q-btn
            to="/register"
            flat no-caps
            label="Registra't si no tens compte!"
...
async function onSubmit() {
  ...
  try {
    ...
    $q.notify({ type: 'positive', message: 'Benvingut, has Logat amb èxit.' })
  } catch (error) {
...
.github-btn:hover { background: #111827 !important; }
</style>
